...
search_content = "555088-061"
single_url = "https://gateway.stockx.com/api/v2/search?facets=%5B%22product_category%22%5D&page=0&query="+search_content+"&currency=USD"
headers = {
...
for k,v in detail_dict['Product']['children'].items():
    ...
    print(shoeSize,highestBid,lowestAsk)
